...
function SearchContent() {
   ...
   return (
      <div className="h-screen overflow-y-scroll bg-[#F9FAFB] text-neutral-900 font-sans pb-24">
         {/* ========== HEADER (Sticky) ========== */}
         <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-neutral-200/60 transition-all duration-300">
            <div className="max-w-md mx-auto px-4 h-14 flex items-center justify-between">
               <Link href="/" className="p-2 -ml-2 hover:bg-neutral-100 rounded-full transition-colors text-neutral-600">
         ...
         <main className="max-w-md mx-auto px-4 pt-4 space-y-6">
            ...
            <div className="bg-white p-5 rounded-3xl shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)] border border-neutral-100">
               <div className="flex gap-5">
                  <div className="w-28 h-36 flex-shrink-0 bg-neutral-100 rounded-2xl overflow-hidden relative shadow-inner">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-1">
                     <div>
                        ...
                        <h1 className="text-lg font-bold text-neutral-900 leading-snug line-clamp-2">
                           {data.basicInfo.title}
                        </h1>
                     </div>
                     ...
                     <div>
                        <div className="flex items-baseline gap-2">
                           {data.basicInfo.discountRate > 0 && (
                              <span className="text-2xl font-extrabold text-red-600 mr-1">
               ...
               <div className="mt-5 grid grid-cols-[1fr_auto] gap-3">
                  {data.basicInfo.link && (
                     <a href={data.basicInfo.link} target="_blank"
                        className={`h-11 rounded-xl text-sm font-bold transition-all active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg ${data.basicInfo.isSoldOut ? 'bg-neutral-300 text-white cursor-not-allowed shadow-none' : 'bg-black text-white hover:bg-neutral-800 shadow-black/10'}`}
                  ...
                  <a href={`https://lens.google.com/uploadbyurl?url=${encodeURIComponent(data.basicInfo.imageUrl)}`} target="_blank"
                     className="h-11 px-4 bg-neutral-100 text-neutral-600 rounded-xl font-bold text-sm flex items-center justify-center hover:bg-neutral-200 transition-colors">
                     <ScanEye size={18} />
                  </a>
               </div>
            </div>
            ...
            {/* ========== TABS ========== */}
            <div className="bg-neutral-100/80 p-1 rounded-xl flex relative">
               <button
                              ...
                              {brand.length > 0 && (
                                 <div>
                                    ...
                                    <div className="grid grid-cols-2 gap-3">
                                       {brand.slice(0, 4).map((y: any, i: number) => (
